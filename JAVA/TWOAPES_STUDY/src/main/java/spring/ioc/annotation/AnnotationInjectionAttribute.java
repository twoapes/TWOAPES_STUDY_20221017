...
import spring.ioc.annotation.attribute.componentScan.AppConfig2;
...
public class AnnotationInjectionAttribute extends AnnotationDI {
    ...
    public static void value() {
        ...
        ApplicationContext context = ApplicationUtil.openClass(spring.ioc.annotation.attribute.value.AppConfig.class);
    ...
    public static void bean() {
        ...
        log.info(stringBuilder);
        ApplicationContext context = ApplicationUtil.openClass(spring.ioc.annotation.attribute.bean.AppConfig.class);
        ...
        context = ApplicationUtil.openClass(spring.ioc.annotation.attribute.bean.AppConfig.class);
    ...
    public static void configuration() {
        ...
        log.info(stringBuilder);
        ApplicationContext context = ApplicationUtil.openClass(spring.ioc.annotation.attribute.configuration.AppConfig.class);
    ...
    private static void componentScanDI1() {
        ...
        log.info(stringBuilder);
        ApplicationContext context = ApplicationUtil.openClass(spring.ioc.annotation.attribute.componentScan.AppConfig.class);
    ...
    private static void componentScanDI2() {
        ...
        log.info(stringBuilder);
        ApplicationContext context = ApplicationUtil.openClass(AppConfig2.class);
    ...
    private static void componentScanDI3() {
        ...
        ComponentScanService componentScanService = componentScanService(context);
        log.info("componentScanService:" + componentScanService);
        context = ApplicationUtil.openClass(AppConfig2.class);
