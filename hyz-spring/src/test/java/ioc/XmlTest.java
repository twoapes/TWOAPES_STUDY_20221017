...
@Slf4j
public class XmlTest extends BeanUtil {
    /**
    ...
    public void createObject() {
        Student student = getBean(Student.class, "ioc", "object", "object");
        student(student);
    }
    ...
    @Test
    public void alias() {
        Student student = getBean(Student.class, "ioc", "object", "aliasObject");
        student(student);
    }
    ...
    public void property() {
        Student student = getBean(Student.class, "ioc", "property");
        student(student);
    }
    ...
    public void pNameSpace() {
        Student student = getBean(Student.class, "ioc", "pNameSpace");
        student(student);
    }
    ...
    public void nullLabel() {
        Student student = getBean(Student.class, "ioc", "null");
        student(student);
    }
    ...
    @Test
    public void special() {
        Student student = getBean(Student.class, "ioc", "special", "special1");
        student(student);
        student = getBean(Student.class, "ioc", "special", "special2");
        student(student);
    }
    ...
    public void xmlService() {
        XmlService xmlService = getBean(XmlService.class, "ioc", "xmlService");
        xmlService.xml();
    }
    ...
    @Test
    public void inside() {
        Teacher teacher = getBean(Teacher.class, "ioc", "inside");
    ...
    public void cascade1() {
        Teacher teacher = getBean(Teacher.class, "ioc", "cascade", "cascade1");
        Student student = teacher.getStudent();
        student(student);
        teacher = getBean(Teacher.class, "ioc", "cascade", "cascade2");
    ...
    public void aggregate() {
        ...
        Teacher teacher = getBean(Teacher.class, "ioc", "aggregate", "aggregate1");
        ...
        teacher = getBean(Teacher.class, "ioc", "aggregate", "aggregate2");
    ...
    public void scope() {
        ...
        Student student1 = getBean(Student.class, "ioc", "scope", "scope1");
        Student student2 = getBean(Student.class, "ioc", "scope", "scope1");
        StringBuilder stringBuilder = new StringBuilder("\n");
        ...
        student1 = getBean(Student.class, "ioc", "scope", "scope2");
        student2 = getBean(Student.class, "ioc", "scope", "scope2");
        stringBuilder.setLength(0);
    ...
    public void lifeCycle() {
        ...
        LifeCycle lifeCycle = getBean(LifeCycle.class, "ioc", "lifeCycle");
        log.info("The fourth step:call object\t" + lifeCycle);
        log.info("\n\n--------------has after advice--------------");
        UnLifeCycle unLifeCycle = getBean(UnLifeCycle.class, "ioc", "unLifeCycle");
    ...
    public void autowired() {
        Student student = getBean(Student.class, "ioc", "autowired", "autowired1");
        student(student);
        student = getBean(Student.class, "ioc", "autowired", "autowired2");
        student(student);
    }
    ...
    public void constructor() {
        Student student = getBean(Student.class, "ioc", "constructorArg", "constructorArg1");
        student(student);
        student = getBean(Student.class, "ioc", "constructorArg", "constructorArg2");
        student(student);
        student = getBean(Student.class, "ioc", "constructorArg", "constructorArg3");
        student(student);
        student = getBean(Student.class, "ioc", "constructorArg", "constructorArg4");
        student(student);
    }
    ...
    public void properties() {
        ...
        pojo.Properties pro = getBean(pojo.Properties.class, "ioc", "properties");
    ...
    public void statics() {
        ...
        Static aStatic = getBean(Static.class, "ioc", "static");
        ...
        Static1 static1 = getBean(Static1.class, "ioc", "static", "static1");

        stringBuilder.append("static1 object init success").append("\n");
        stringBuilder.append("static1:").append(static1).append("\n");

        Static2 static2 = getBean(Static2.class, "ioc", "static", "static2");
    ...
    public void imports() {
        ...
        pojo.Import anImport = getBean(pojo.Import.class, "ioc", "import");
        ...
        Import1 import1 = getBean(Import1.class, "ioc", "import", "import1");
        stringBuilder.append("import1 object init success").append("\n");
        stringBuilder.append("import1:").append(import1).append("\n");

        Import2 import2 = getBean(Import2.class, "ioc", "import", "import2");
        ...
        anImport = getBean(pojo.Import.class, "ioc", "import");

        stringBuilder.append("anImport object init success").append("\n");
        stringBuilder.append("import1:").append(anImport.getImport1()).append("\n");
        stringBuilder.append("import2:").append(anImport.getImport2()).append("\n");

        import1 = getBean(Import1.class, "ioc", "import", "import1");
        stringBuilder.append("import1 object init success").append("\n");
        stringBuilder.append("import1:").append(import1).append("\n");

        import2 = getBean(Import2.class, "ioc", "import", "import2");
        stringBuilder.append("import2 object init success").append("\n");
        stringBuilder.append("import2:").append(import2).append("\n");
